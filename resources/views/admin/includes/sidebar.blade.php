    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('MainSalaryEmployee.index') }}"
                            class="nav-link {{ request()->is('admin/MainSalaryEmployee*') ? 'active' : '' }}">
                            <i class="far fa-circle nav-icon"></i>
            ...
            {{-- نهاية التحقيقات الادارية  --}}
              ...
              <li
              class="nav-item has-treeview  {{ request()->is('admin/SystemMonitoring*') ? 'menu-open' : '' }}">
              <a href="#"
                  class="nav-link {{ request()->is('admin/SystemMonitoring*') ? 'active' : '' }}">
                  <i class="nav-icon fas fa-tachometer-alt"></i>
                  <p>
                      قائمة المرقابة
                      <i class="right fas fa-angle-left"></i>
              ...
              <ul class="nav nav-treeview">
                  <li class="nav-item">
                      <a href="{{ route('SystemMonitoring.index') }}"
                          class="nav-link {{ request()->is('admin/SystemMonitoring*') ? 'active' : '' }}">
                          <i class="far fa-circle nav-icon"></i>
                          <p>سجل مراقبة النظام</p>
                      </a>
                  </li>

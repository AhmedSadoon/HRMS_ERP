    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title card_title_center">بيانات بصمات الموظفين بالشهور المالية
                </h3>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                                ...
                                                @if ($info->is_open != 0 )
                                                    <a href="{{route('AttendanceDeparture.show',$info->id)}}" class="btn btn-sm btn-success">عرض</a>
                                                @endif

    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title card_title_center">تعديل بيانات ادارة </h3>
            </div>
            ...
            <div class="card-body">
             ...
             <form action="{{route('departements.update',$data['id'])}}" method="POST">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="phones" id="phones" class="form-control"
                            value="{{ old('phones',$data['phones']) }}" oninput="this.value=this.value.replace(/[^0-9.]/g,'');">
                        @error('phones')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label>ملاحظات على الادارة</label>
                ...
                <div class="col-md-12">
                    <div class="form-group text-center">
                       ...
                       <a href="{{route('departements.index')}}" class="btn btn-sm btn-danger">الغاء</a>
                    </div>
                </div>

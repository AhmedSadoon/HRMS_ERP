                                ...
                                <div class="tab-pane fade show active" id="custom-content-personal_data" role="tabpanel"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="emp_gender" id="emp_gender" class="form-control">
                                                    ...
                                                    <option @if (old('emp_gender') == 1) selected @endif
                                                        value="1">ذكر</option>
                                                    <option @if (old('emp_gender') == 2 and old('emp_gender') != '') selected @endif
                                                        value="2">انثى</option>
                                                </select>
                                                @error('emp_gender')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="graduation_estimate" id="graduation_estimate"
                                                    ...
                                                    <option @if (old('graduation_estimate') == 2 and old('graduation_estimate') != '') selected @endif
                                                        value="2">متوسط</option>
                                                    <option @if (old('graduation_estimate') == 3 and old('graduation_estimate') != '') selected @endif
                                                        value="3">جيد</option>
                                                    <option @if (old('graduation_estimate') == 4 and old('graduation_estimate') != '') selected @endif
                                                        value="4">جيد جدا</option>

                                                    <option @if (old('graduation_estimate') == 5 and old('graduation_estimate') != '') selected @endif
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="emp_national_identity"
                                                    ...
                                                    value="{{ old('emp_national_identity') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="date" name="emp_endDate_identityID"
                                                    ...
                                                    value="{{ old('emp_endDate_identityID') }}">
                                                ...
                                                <select name="blood_group_id" id="blood_group_id"
                                                    ...
                                                    @if (@isset($other['blood_groups']) && !@empty($other['blood_groups']))
                                                        @foreach ($other['blood_groups'] as $info)
                                                            <option
                                                                @if (old('blood_groups_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select name="emp_nationalitie_id" id="emp_nationalitie_id"
                                                    ...
                                                    @if (@isset($other['nationalities']) && !@empty($other['nationalities']))
                                                        @foreach ($other['nationalities'] as $info)
                                                            <option
                                                                @if (old('nationalities_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select name="emp_lang_id" id="emp_lang_id"
                                                    ...
                                                    @if (@isset($other['languages']) && !@empty($other['languages']))
                                                        @foreach ($other['languages'] as $info)
                                                            <option
                                                                @if (old('languages_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select name="religion_id" id="religion_id"
                                                    ...
                                                    @if (@isset($other['religions']) && !@empty($other['religions']))
                                                        @foreach ($other['religions'] as $info)
                                                            <option
                                                                @if (old('religions_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                                ...
                                                <select name="governorate_id" id="governorate_id"
                                                    ...
                                                    @if (@isset($other['governorates']) && !@empty($other['governorates']))
                                                        @foreach ($other['governorates'] as $info)
                                                            <option
                                                                @if (old('governorate_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}">
                                                                {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                ...
                                                <select name="city_id" id="city_id" class="form-control select2 ">
                                                    ...
                                                    @if (@isset($other['centers']) && !@empty($other['centers']))
                                                        @foreach ($other['centers'] as $info)
                                                            <option
                                                                @if (old('city_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="states_address" id="states_address"
                                                    class="form-control" value="{{ old('states_address') }}">
                                                ...
                                                <select name="emp_military_status_id" id="emp_military_status_id"
                                                    ...
                                                    @if (@isset($other['military_statuses']) && !@empty($other['military_statuses']))
                                                        @foreach ($other['military_statuses'] as $info)
                                                            <option
                                                                @if (old('military_statuses_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="col-md-4 related_military_1"
                                            @if (old('emp_military_status_id') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 related_military_2"
                                            @if (old('emp_military_status_id') != 2) style="display: none;" @endif>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4 related_military_3"
                                            @if (old('emp_military_status_id') != 3) style="display: none;" @endif>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="does_has_driving_license" id="does_has_driving_license"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('does_has_driving_license') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('does_has_driving_license') == 0 and old('does_has_driving_license') != '') selected @endif
                                                        value="0">لا</option>
                                                ...
                                                <select name="driving_license_types_id" id="driving_license_types_id"
                                                    ...
                                                    @if (@isset($other['driving_license_types']) && !@empty($other['driving_license_types']))
                                                        @foreach ($other['driving_license_types'] as $info)
                                                            <option
                                                                @if (old('driving_license_types_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}"> {{ $info->name }}
                                                            </option>
                                                        @endforeach
                                                    @endif
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="has_relatives" id="has_relatives" class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('has_relatives') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('has_relatives') == 0 and old('has_relatives') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-12 related_relatives_details"
                                            @if (old('has_relatives') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                                <label>تفاصيل الاقارب</label>
                                                <textarea autofocus type="text" name="relatives_details" id="relatives_details" class="form-control">{{ old('relatives_details') }}</textarea>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_disabilities_processes" id="is_disabilities_processes"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('is_disabilities_processes') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('is_disabilities_processes') == 0 and old('is_disabilities_processes') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-8 related_is_disabilities_processes"
                                            @if (old('is_disabilities_processes') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                                <label>تفاصيل الاعاقة</label>
                                                <textarea autofocus type="text" name="disabilities_processes" id="disabilities_processes" class="form-control">{{ old('disabilities_processes') }}</textarea>
                                        ...
                                        <div class="col-md-12 ">
                                            <div class="form-group">
                                                <label>ملاحظات</label>
                                                <textarea autofocus type="text" name="notes" id="notes" class="form-control">{{ old('notes') }}</textarea>
                                                @error('notes')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="tab-pane fade" id="custom-content-jobs_data" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="function_status" id="function_status" class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('function_status') == 1) selected @endif
                                                        value="1">يعمل</option>
                                                    <option @if (old('function_status') == 0 and old('function_status') != '') selected @endif
                                                ...
                                                <select name="emp_department_id" id="emp_department_id"
                                                    ...
                                                    @if (@isset($other['departments']) && !@empty($other['departments']))
                                                        @foreach ($other['departments'] as $info)
                                                            <option
                                                                @if (old('emp_department_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}">{{ $info->name }}</option>
                                                        @endforeach
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="does_has_ateendance" id="does_has_ateendance"
                                                    class="form-control">
                                                    <option @if (old('does_has_ateendance') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('does_has_ateendance') == 0 and old('does_has_ateendance') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_has_fixced_shift" id="is_has_fixced_shift"
                                                    ...
                                                    <option @if (old('is_has_fixced_shift') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('is_has_fixced_shift') == 0 and old('is_has_fixced_shift') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-4 relatedfixced_shift"
                                            @if (old('is_has_fixced_shift') == 0 || old('is_has_fixced_shift') == '') style="display: none;" @endif>
                                            <div class="form-group">
                                                ...
                                                <select name="shift_type_id" id="shift_type_id"
                                                    ...
                                                    @if (@isset($other['shift_types']) && !@empty($other['shift_types']))
                                                        @foreach ($other['shift_types'] as $info)
                                                            <option
                                                                @if (old('shift_type_id') == $info->id) selected="selected" @endif
                                                                value="{{ $info->id }}">
                                        ...
                                        <div class="col-md-4 daily_work_hourDIV"
                                            @if (old('is_has_fixced_shift') == 1 || old('is_has_fixced_shift') == '') style="display: none;" @endif>
                                            <div class="form-group">
                                                <label>عدد ساعات العمل اليومي</label>
                                                <input autofocus type="text" name="daily_work_hour"
                                                    id="daily_work_hour"
                                                    oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                    class="form-control" value="{{ old('daily_work_hour') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="emp_salary" id="emp_salary"
                                                    oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                    class="form-control" value="{{ old('emp_salary') }}">
                                                @error('emp_salary')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="motivation_type" id="motivation_type" class="form-control">
                                                    ...
                                                    <option @if (old('motivation_type') == 1) selected @endif
                                                        value="1">ثابت</option>
                                                    <option @if (old('motivation_type') == 2) selected @endif
                                                        value="2">متغير</option>
                                                    <option @if (old('motivation_type') == 0 and old('motivation_type') != '') selected @endif
                                        ...
                                        <div class="col-md-4 motivationDiv"
                                            @if (old('motivation_type') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_social_nsurance" id="is_social_nsurance"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('is_social_nsurance') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('is_social_nsurance') == 0 and old('is_social_nsurance') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-4 relatedsocial_nsurance"
                                            @if (old('is_social_nsurance') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="social_nsurance_cutMonthely"
                                                    ...
                                                    oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                    class="form-control"
                                                    value="{{ old('social_nsurance_cutMonthely') }}">
                                        ...
                                        <div class="col-md-4 relatedsocial_nsurance"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="social_nsurance_number"
                                                    ...
                                                    value="{{ old('social_nsurance_number') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_medical_nsurance" id="is_medical_nsurance"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('is_medical_nsurance') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('is_medical_nsurance') == 0 and old('is_medical_nsurance') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-4 relatedmedical_nsurance"
                                            @if (old('is_medical_nsurance') != 1) style="display: none;" @endif>
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="medical_nsurance_cutMonthely"
                                                    ...
                                                    oninput="this.value=this.value.replace(/[^0-9.]/g,'');"
                                                    class="form-control"
                                                    value="{{ old('medical_nsurance_cutMonthely') }}">
                                        ...
                                        <div class="col-md-4 relatedmedical_nsurance"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="medical_nsurance_number"
                                                    ...
                                                    value="{{ old('medical_nsurance_number') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="sal_cach_or_visa" id="sal_cach_or_visa"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('sal_cach_or_visa') == 1) selected @endif
                                                        value="1">كاش</option>
                                                    <option @if (old('sal_cach_or_visa') == 2) selected @endif
                                                        value="2">فيزا</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="is_active_for_vaccation" id="is_active_for_vaccation"
                                                    class="form-control">
                                                    <option value="">اختر الحالة</option>
                                                    <option @if (old('is_active_for_vaccation') == 1) selected @endif
                                                        value="1">نعم</option>
                                                    <option @if (old('is_active_for_vaccation') == 0 and old('is_active_for_vaccation') != '') selected @endif
                                                        value="0">لا</option>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="emp_cafel" id="emp_cafel"
                                                    class="form-control" value="{{ old('emp_cafel') }}">
                                                @error('emp_cafel')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" name="emp_pasport_no" id="emp_pasport_no"
                                                    class="form-control" value="{{ old('emp_pasport_no') }}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="file" name="emp_photo" id="emp_photo"
                                                    class="form-control" value="{{ old('emp_photo') }}">
                                                @error('emp_photo')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="file" name="emp_cv" id="emp_cv"
                                                    class="form-control" value="{{ old('emp_cv') }}">
                                                @error('emp_cv')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>

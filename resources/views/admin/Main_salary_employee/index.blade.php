    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-header">
                <h3 class="card-title card_title_center">بيانات رواتب الموظفين مفصلة
                </h3>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif
                                                ...
                                                @if ($info->is_open != 0 )
                                                    <a href="{{route('MainSalaryEmployee.show',$info->id)}}" class="btn btn-sm btn-success">عرض الرواتب</a>
                                                @endif

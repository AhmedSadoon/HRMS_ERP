...
function get_cols_where_paginate($model=null, $columns_names = array(), $where = array(), $order_field="id",$order_type="DESC",$pagination_counter=13)
{
$data = $model::select($columns_names)->where($where)->orderby($order_field, $order_type)->paginate($pagination_counter);
return $data;
}

function get_cols_where_paginate_order2($model=null, $columns_names = array(), $where = array(), $order_field1="id",$order_type1="DESC", $order_field2="id",$order_type2="DESC",$pagination_counter=13)
{

...
class Main_salary_employee_sanctionsController extends Controller
{
    ...
    public function store(Request $request){
        ...
        if($request->ajax()){
            ...
            $flag=insert(new Main_salary_employee_sanctions(),$dataToInsert);
            if($flag){
    ...
    public function delete_row(Request $request) {
        ...
        if($request->ajax()){
            ...
            if(!empty($finance_cin_periods_data) and !empty($data_row) and !empty($main_salary_employee_data)){
               ...
               $flag= destroy(new Main_salary_employee_sanctions(),array('com_code'=>$com_code,'id'=>$request->id,'is_archived'=>0,'finance_cin_periods_id'=>$request->the_finance_cin_periods_id,'main_salary_employee_id'=>$request->main_salary_employee_id));
    ...
    public function do_edit_row(Request $request){
        ...
        if($request->ajax()){
            ...
            $main_salary_employee_data=get_cols_where_row(new Main_salary_employee(),array("id"),array('com_code'=>$com_code,'finance_cin_periods_id'=>$request->the_finance_cin_periods_id,'employees_code'=>$request->employees_code,'is_archived'=>0,'id'=>$request->main_salary_employee_id));
            $data_row=get_cols_where_row(new Main_salary_employee_sanctions(),array("*"),array('com_code'=>$com_code,'id'=>$request->id,'is_archived'=>0,'finance_cin_periods_id'=>$request->the_finance_cin_periods_id,'main_salary_employee_id'=>$request->main_salary_employee_id));
            ...
            $flag=update(new Main_salary_employee_sanctions(),$dataToUdate,array('com_code'=>$com_code,'id'=>$request->id,'is_archived'=>0,'finance_cin_periods_id'=>$request->the_finance_cin_periods_id,'main_salary_employee_id'=>$request->main_salary_employee_id));
            if($flag){
                $this->Recalculate_main_salary_employee($request->main_salary_employee_id);
            }
            DB::commit();

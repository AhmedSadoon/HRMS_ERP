...
class Main_salary_employee_AdditionController extends Controller
{
    ...
    public function show($finance_cin_periods_id){
        ...
        return view('admin.Main_salary_employee_addition.show', ['data'=>$data,'finance_cin_periods_data'=>$finance_cin_periods_data,'employees'=>$employees,'employees_search'=>$employees_search,'additional_types'=>$additional_types]);
    ...
    public function ajax_search(Request $request) {
        if($request->ajax()){
            ...
            $com_code = auth()->user()->com_code;
            $data = Main_salary_employee_addition::select("*")->where($field1,$operator1,$value1)->where($field2,$operator2,$value2)->where($field3,$operator3,$value3)->where('finance_cin_periods_id','=',$the_finance_cin_periods_id)->where('com_code','=',$com_code)->orderBy('id','DESC')->paginate(PAGINATION_COUNTER);
    ...
    public function load_edit_row(Request $request) {
        if($request->ajax()){
            ...
            return view('admin.Main_salary_employee_addition.load_edit_row',['finance_cin_periods_data'=>$finance_cin_periods_data,'main_salary_employee_data'=>$main_salary_employee_data,'data_row'=>$data_row,'employees'=>$employees,'additional_types'=>$additional_types]);
        }
    ...
    public function print_search(Request $request) {
            ...
            $other['value_sum']=0;
            $other['total_sum']=0;
            $data = Main_salary_employee_addition::select("*")->where($field1,$operator1,$value1)->where($field2,$operator2,$value2)->where($field3,$operator3,$value3)->where('finance_cin_periods_id','=',$the_finance_cin_periods_id)->where('com_code','=',$com_code)->orderBy('id','DESC')->get();

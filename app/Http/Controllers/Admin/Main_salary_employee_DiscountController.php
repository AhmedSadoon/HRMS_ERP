    ...
    public function delete_row(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (!empty($finance_cin_periods_data) and !empty($data_row) and !empty($main_salary_employee_data)) {
                ...
                destroy(new Main_salary_employee_discount(), array('com_code' => $com_code, 'id' => $request->id, 'is_archived' => 0, 'finance_cin_periods_id' => $request->the_finance_cin_periods_id, 'main_salary_employee_id' => $request->main_salary_employee_id));
    ...
    public function do_edit_row(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            if (!empty($finance_cin_periods_data) && !empty($main_salary_employee_data) && !empty($data_row)) {
                ...
                update(new Main_salary_employee_discount(), $dataToUdate, array('com_code' => $com_code, 'id' => $request->id, 'is_archived' => 0, 'finance_cin_periods_id' => $request->the_finance_cin_periods_id, 'main_salary_employee_id' => $request->main_salary_employee_id));
                DB::commit();
